...
public class InsuranceOverviewPOM {
	...
	@FindBy (xpath = ".//*[@id='page-content']/div/div/div[2]/div/div/div[1]/div/div[2]/p[2]/a")
    WebElement learnMoreAboutLifeInsuranceTab;
	
	@FindBy (xpath = ".//*[@id='page-content']/div/div/div[2]/div/div/div[2]/div/div[2]/p[2]/a")
	public WebElement learnMoreAboutHealthInsuranceTab;
	
	@FindBy (xpath = ".//*[@id='page-content']/div/div/div[2]/div/div/div[1]/div/div[2]/p[3]/a")
	//
	WebElement lifeInsuranceCalculatorTab;
	
	@FindBy (xpath = ".//*[@id='page-content']/div/div/div[2]/div/div/div[2]/div/div[2]/p[3]/a[1]")
	WebElement buildingTab;
	
	@FindBy (xpath = ".//*[@id='page-content']/div/div/div[2]/div/div/div[2]/div/div[2]/p[3]/a[2]")
    WebElement preretirementTab;
	
	@FindBy (xpath = ".//*[@id='page-content']/div/div/div[3]/div/div/div/div/div[1]/h4/a")
	WebElement pHITab;
	
	@FindBy (xpath = ".//*[@id='consumerPC']")
	WebElement postalTab;
	
	@FindBy (xpath = ".//*[@id='page-content']/div/div/div[4]/div[2]/div/form/div[2]/input[2]")
